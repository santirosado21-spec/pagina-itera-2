import { Dashboard, Evidence, Footer, Nav, PageShell, ProductScreens, ProductWorkbench, Proof, Reveal, Simulation } from '../components/Site'
...
export function ProductLedPage({ kinetic = false }) { return <PageShell className={`option option-one ${kinetic ? 'option-four' : ''}`}><Nav /><main id="main">
  ...
  <section className="measurement section"><div className="container split"><div><p className="eyebrow">Product format</p><h2>Small sessions. Defensible evidence.</h2><p className="citation">Organizations with high shadow-AI use averaged $670K more in breach costs — IBM, Cost of a Data Breach Report 2025.</p></div><Proof /></div></section>
  <Testimonials />
