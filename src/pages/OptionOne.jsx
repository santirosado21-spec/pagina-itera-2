...
import BuiltWithItera from '@/components/ui/built-with-itera'
...
export function ProductLedPage({ kinetic = false, background = 'signal' }) { return <PageShell className={`option option-one ${kinetic ? `option-four option-four-bg-${background}` : ''}`}><Nav productLed /><main id="main">
